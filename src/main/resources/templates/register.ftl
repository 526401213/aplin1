    ...
    <form class="form form-horizontal" action="index.html" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input name="" type="button" onclick="sub()" class="btn btn-success radius size-L" value="&nbsp;确&nbsp;&nbsp;&nbsp;&nbsp;定&nbsp;">
          <a href="javascript:history.go(-1)"><input  type="button" class="btn btn-default radius size-L" value="&nbsp;返&nbsp;&nbsp;&nbsp;&nbsp;回&nbsp;"></a>
        </div>
      </div>
    </form>
  </div>
